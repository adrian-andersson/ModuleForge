...
function build-mfProject
{
    ...
    process{
        ...
        Write-Information "File Dependency Tree:`n`n$($(get-mfdependencyTree ($folderItemDetails|Select-Object relativePath,dependencies)) -join "`n")" -tags 'DependencyTree' -informationVariable DependencyTree
