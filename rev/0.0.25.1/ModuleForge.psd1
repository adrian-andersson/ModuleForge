...
FunctionsToExport = 'build-mfProject', 'get-mfFolderItems', 'get-mfScriptText', 
...
PrivateData = @{
    ...
    # moduleRevision
    moduleRevision = '0.0.25.1'

    # bartenderVersion
    bartenderVersion = '6.2.0'

    # builtOn
    builtOn = '2024-07-26T13:39:53'
