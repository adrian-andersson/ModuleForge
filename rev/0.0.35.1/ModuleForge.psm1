...
function get-mfDependencyTreeMermaid
{
    ...
    <#
        ...
        ------------
        .EXAMPLE
            $folderItemDetails = get-mfFolderItemDetails -path $path -Verbose
    ...
    process{
        ...
        $mermaidDiagram = New-Object System.Collections.Generic.List[string]
        $mermaidDiagram.add('flowchart TD')
        foreach($dep in $dependencies)
        {
            $mermaidDiagram.add("'$($dep.child)' --> '$($dep.Parent)'")
        }
        
        $mermaidDiagram -join "`n"
    }
