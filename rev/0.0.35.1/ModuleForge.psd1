...
FunctionsToExport = 'add-mfRepositoryXmlData', 'build-mfProject', 
               'get-mfDependencyTreeMermaid', 'get-mfFolderItemDetails', 
               'get-mfFolderItems', 'get-mfNextSemver', 'Get-mfScriptDetails', 
               'get-mfScriptText', 'new-mfProject', 'publish-mfGithubPackage', 
