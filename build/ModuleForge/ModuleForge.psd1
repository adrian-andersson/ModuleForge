...
FunctionsToExport = 'add-mfGithubScaffold', 'add-mfRepositoryXmlData', 'build-mfProject', 
               'get-mfDependencyTree', 'get-mfFolderItemDetails', 
               'get-mfFolderItems', 'get-mfGitChangeLog', 'get-mfGitLatestVersion', 
               'get-mfLatestSemverFromBuildManifest', 'get-mfNextSemver', 
               'new-mfProject', 'register-mfLocalPsResourceRepository', 
