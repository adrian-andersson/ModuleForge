...
function build-mfProject
{
    ...
    PARAM(
        ...
        [Parameter()]
        [semver]$version = [semver]::new('0.0.1'),
    ...
    process{
        ...
        if($prerelease)
        {
            ...
            write-verbose "Setting Prerelease tag to: $prerelease"
            $splatManifest.Prerelease = $prerelease

        }

        #I've never seen anyone use the filelist part of a manifest
        #But lets try it out
...
function get-mfDependencyTreeAsJob
{
    ...
    process{
        ...
        [scriptblock]$sblock = {
            ...
            $itemDetails = $folderItems.ForEach{
                $relPath = join-path -path $relPathBase -childpath $(join-path $_.folder -childpath $_.RelativePath.Substring(1))
...
function publish-mfGithubPackage
{
    ...
    <#
        ...
        .DESCRIPTION
            This step should run _after_ you update the NUSPEC XML
...
$githubRepo = "<Your GitHub repository>"
$githubToken = "<Your GitHub token>"
$filePath = "<Path to your .nupkg file>"
...
# Call the GitHub API
$response = Invoke-RestMethod -Uri $apiUrl -Method Put -Body $jsonBody -Headers @{ "Authorization" = "token $githubToken" }
#>
