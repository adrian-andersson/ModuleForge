...
## Version: v1.3.0-prev006


### New Features

- move the scriptblock from Get-MFFolderItemDetails into an external file to improve readability and portabilty
- Update Wrige-MFModuleDocs to hold frontMatter in memory, resulting in less likelyhood of clobbering the existing docs



### Bug Fixes

- Remove Invoke-MFPester as a function, port it to a stand-alone script file so that module scope and debug errors resolve correctly.
