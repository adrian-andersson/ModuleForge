function Resolve-MFModuleCase
{
    ...
    <#
        ...
        .DESCRIPTION
            ...
            created in lowercase while the manifest keeps its PascalCase name. That folder/manifest mismatch
            effectively breaks discoverability (Get-Module, Import-Module). This function corrects it by renaming the
